  ...
  return (
    <section className="toDos">
        ...
        {currentUser.email === import.meta.env.VITE_ADMIN_EMAIL &&
            <div className="p-2 mb-3 text-center catCreate">
                {!showCreate ? 
                    <button onClick={() => setShowCreate(true)} className="btn btn-outline-info">Create Category</button> : 
                    <>
        ...
        <div className="container p-2">
            <table className="table bg-info table-dark table-hover table-striped my-3" id='catTable'>
